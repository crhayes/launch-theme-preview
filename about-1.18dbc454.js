...
var _colorModeToggler = require("./color-mode-toggler");
var _stickyNav = require("./sticky-nav");
window.addEventListener("DOMContentLoaded", ()=>{
    (0, _colorModeToggler.initColorModeToggler)();
});
document.querySelectorAll("[data-enter-viewport-class]").forEach((element)=>{
    const observer = new IntersectionObserver((entries)=>{
        entries.forEach((entry)=>{
            if (entry.isIntersecting) entry.target.classList.add(...entry.target.dataset.enterViewportClass.split(" "));
        });
    }, {
        threshold: 0.75
    });
...
},{"bootstrap":"h36JB","./color-mode-toggler":"4ptzK","./sticky-nav":"41ldy"}],"h36JB":[function(require,module,exports) {
/*!
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4ptzK":[function(require,module,exports) {
/*!
 ...
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initColorModeToggler", ()=>initColorModeToggler) // (() => {
 //   "use strict";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"41ldy":[function(require,module,exports) {
/**
 * Adds a shadow to the topbar when content is scrolled underneath.
 */ class StickyNav extends HTMLElement {
    ...
    scrollListener = ()=>{
        requestAnimationFrame(this.toggleClass.bind(this));
    };
    toggleClass() {
        if (window.scrollY === 0) this.classList.remove(...StickyNav.classesToAdd);
        else if (this.lastScrollY === 0) this.classList.add(...StickyNav.classesToAdd);
        this.lastScrollY = window.scrollY;
    }
}
customElements.define("sticky-nav", StickyNav);

},{}]},["46McK","1SICI"], "1SICI", "parcelRequire69ab")

//# sourceMappingURL=about-1.18dbc454.js.map
